...
const STUNNED := preload("res://mods-unpacked/CrazyMew37-CrazyCrossovers/extensions/objects/battle/battle_resources/status_effects/status_effect_stunned.tres")
...
const LEEK := preload("res://mods-unpacked/CrazyMew37-CrazyCrossovers/extensions/objects/items/custom/rose_animated.tscn")
...
const SFX_HIT := preload("res://audio/sfx/battle/cogs/attacks/SA_powertie_throw.ogg")
...
func cutscene(cogs : Array[Cog]) -> void:
	...
	tween1.tween_callback(affect_cog.bind(BattleService.ongoing_battle.cogs.pick_random()))
