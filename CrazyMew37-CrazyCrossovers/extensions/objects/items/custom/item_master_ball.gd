...
const ACC_POOL = preload("res://objects/items/pools/special_items.tres")

func use() -> void:
	AudioManager.play_sound(load('res://mods-unpacked/CrazyMew37-CrazyCrossovers/extensions/audio/sfx/pokeballopen.ogg'))
