...
const BLANKET_EFFECT := preload("res://mods-unpacked/CrazyMew37-CrazyCrossovers/extensions/objects/battle/effects/bayoen_effect.tscn")
const TRIP_EFFECT := preload("res://mods-unpacked/CrazyMew37-CrazyCrossovers/extensions/objects/battle/effects/bayoen_bar.tscn")
