...
func play() -> Tween:
	...
	movie = Sequence.new([
		...
		Func.new(monika.turn_to_face.bind(directory.second_pos.global_position, 0.5)),
		Wait.new(0.5),
		...
		Func.new(sayori.turn_to_face.bind(directory.second_pos.global_position, 1.0)),
		Func.new(yuri.turn_to_face.bind(directory.second_pos.global_position, 1.0)),
		Func.new(natsuki.turn_to_face.bind(directory.second_pos.global_position, 1.0)),
		Wait.new(1.0),
